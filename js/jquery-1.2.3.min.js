  ...
  jQuery.fn = jQuery.prototype = {
    init: function (selector, context) {
      ...
      return this.setArray(
        (selector.constructor == Array && selector) || ((selector.jquery || (selector.length && selector != window && !selector.nodeType && selector[0] != undefined && selector[0].nodeType)) && jQuery.makeArray(selector)) || [selector]
      );
    },
    jquery: '1.2.3',
    size: function () {
    ...
    add: function (selector) {
      return !selector
        ? this
        : this.pushStack(jQuery.merge(this.get(), selector.constructor == String ? jQuery(selector).get() : selector.length != undefined && (!selector.nodeName || jQuery.nodeName(selector, 'form')) ? selector : [selector]));
    },
